                    ...
                    <div class="row mt-2 p-2">
                        <div class="col-md-12">
                            <div class="card card-outline card-danger">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive mt-2 p-2">
                                        <table class="table table-striped nowrap" id = "tableOne">
                                            <thead>
                                                <tr>
                    ...
                    <div class="row mt-2 p-2">
                        <div class="col-md-12">
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive mt-2 p-2">
                                        <table class="table table-striped nowrap" id = "tableTwo">
                                            <thead>
                                                <tr>
                                                    <th class = "align-middle text-center">Priority</th>
                                                    <th class = "align-middle text-center">Type</th>
                    ...
                    <div class="row mt-2 p-2">
                        <div class="col-md-12">
                            <div class="card card-outline card-warning">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive mt-2 p-2">
                                        <table class="table table-striped nowrap" id = "tableThree">
                                            <thead>
                                                <tr>
                                                    <th class = "align-middle text-center">Priority</th>
                                                    <th class = "align-middle text-center">Type</th>
                    ...
                    <div class="row mt-2 p-2">
                        <div class="col-md-12">
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive mt-2 p-2">
                                        <table class="table table-striped nowrap" id = "tableFour">
                                            <thead>
                                                <tr>
                                                    <th class = "align-middle text-center">Priority</th>
                                                    <th class = "align-middle text-center">Type</th>
