                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-3 text-center">
                                    @if (auth()->user()->type == 3)
                                        <a href="{{ route('ticket.close.two', $tk->id) }}" class="btn btn-success">
                        ...
                        <section>
                                            ...
                                            <div class="comment-section">
                                                <div class="d-flex flex-row user p-2">
                                                    <div class="d-flex flex-column ml-2">
                                                        <a target="_blank"
                                                           href="{{ route('admin.user', $msg->user->id) }}"
                                                           class="name font-weight-bold">{{ $msg->user->name }}</a>
                                                        <span>{{ date('h:i A, M.d', strtotime($msg->created_at)) }}</span>
                                                    </div>
                                                </div>
                                                <div class="mt-2 p-2">
                            ...
                            <form method="post" action="{{ route('ticket.open.store') }}">
                                @csrf
                                            ...
                                            <div class="">
                                                ...
                                                <div class="mt-2 p-2">
                                                    ...
                                                    <select name="status" id="status" class="form-control rounded-0"
                                                            required>
                                                        <option value="1">User Reply</option>
