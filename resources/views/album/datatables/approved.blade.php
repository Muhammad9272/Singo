<table class="table display nowrap" id="tableThree">
    <thead>
    <tr>
        <th>Name</th>
        ...
        @if ($album->status == 1)
            <tr>
                <td class="align-middle pl-2">
                    <img width="50" height="50" src="{{ $album->cover_route }}">
                </td>
                <td class="align-middle pl-2">
                    {{ $album->title }}
                </td>
    ...
    @endforeach
        ...
        @if($albums->where('status',1)->count()>0)
        <div class="pagination-centered">
            <div class="content">
                <i class="fas fa-arrow-left"></i>
                <p class="m-0">Showing 1 to {{$albums->where('status',1)->count()}} of 1 entries</p>
