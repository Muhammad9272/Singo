                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('albums.store') }}" id="form-submit-new-album">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="upc" maxlength="13" name="upc" class="form-control" placeholder="If you don't have one leave this blank">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 ">
                                        <a href="#" id="spo_url_set" class="btn btn-primary w-100 url" target="_blank">
                                            Check URL
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <a href="#" id="apl_url_set" class="btn btn-primary w-100 url" target="_blank">
                                            Check URL
                                        </a>
                                    </div>
                                </div>
                            ...
                            <span class="text-danger" style="position:relative;z-index:2;">
                                <div class="con-tooltip top">
                                    <button id="add_duplicate" type="button" class="btn btn-sm btn-success">
                                        <i class="fas fa-plus"></i> Add song
                                    </button>

                                    <div class="tooltip " style="top:-70%;left:115%;">
                                        <span class="text-info"> Please click "+Add Song" as often as you want.</span>
                                    </div>
                                </div>
                            </span>

                            <button class="btn btn-sm btn-success" type="submit" id="btn-open-copyright-modal">
...
@push('page_scripts')
    ...
    <script>
        ...
        $('#btn-open-copyright-modal').click(function (e) {
            e.preventDefault();
