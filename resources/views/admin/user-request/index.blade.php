...
@section('content')
    <div class="container-fluid">
        ...
        @if(session('success'))
                    ...
                    @endif
        <div class="row">
            <div class="col-md-12 orig-dtb">
                    <div class="card">
                        <div class="card-header">Pending Requests</div>
                        <div class="card-body  ">
                            <table class="table table-dark table-striped display table-responsive " id = "table_one">
                                <thead>
                                    <tr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <table class="table table-dark table-striped display table-responsive" id = "table_two">
                                <thead>
                                    <tr>
                                        <th class = "align-middle pl-2">SL</th>
                                        <th class = "align-middle pl-2">Album Title</th>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <table class="table table-dark table-striped display table-responsive" id = "table_three">
                                <thead>
                                    <tr>
                                        <th class = "align-middle pl-2">SL</th>
                                        <th class = "align-middle pl-2">Album Title</th>
