                ...
                <div class="card">
                    ...
                    <span class="float-left">
                        ...
                        <form action="{{route('make_primium',$user->id)}}" method="post">
                            @csrf
                            <select name="user_status" id="user_status" class="form-control form-control-success rounded-0" required>
                        ...
                        @if (auth()->user()->type == 3)
                                <form action="{{route('make_primium',$user->id)}}" method="post">
                            @csrf
                            <select name="plan" id="plan" class="form-control form-control-success rounded-0" required>
                                <option hidden value="">Choose...</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                @if(auth()->user()->type == 3 )
                                    ...
                                    @if($user->type != 3 )
                                        <h6><strong>Update Privileges</strong></h6>
                                        ...
                                        <div class="py-3 border-bottom">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h6 class="mt-3"><strong>Delete User</strong></h6>
                                                ...
                                                <div class="col-md-6">
                                                    @if($user->isBanned())
                                                        <h6 class="mt-3"><strong>Unban User</strong></h6>
                                                    ...
                                                    @else
                                                        <h6 class="mt-3"><strong>Ban User</strong></h6>
                                    ...
                                    @endif
                                    <h6 class="mt-3"><strong>Update balance</strong></h6>
