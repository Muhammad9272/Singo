                        ...
                        <div class="col-md-8 offset-md-2">
                            <form action="{{ route('admin.rewards.update', $reward->id)}}" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="title" value="{{$reward->title}}" class="form-control form-control-success"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="subtitle" value="{{$reward->subtitle}}" class="form-control form-control-success" required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" step="0.0001" name="points" value="{{$reward->points}}" class="form-control form-control-success" required >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="rank" value="{{$reward->rank}}" class="form-control form-control-success" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control sumernote" name="detail">
                                            {!! $reward->detail !!}
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                       <div class="form-check">
                                          <input class="form-check-input" type="checkbox" name="is_physical" value="1" id="flexCheckChecked" {{$reward->is_physical==1?'checked':''}} >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">                                     
                                        <div class="picture">
                                            @if($reward->photo)
                                            <img class="img-responsive  profile-img" id="wizardPicturePreview" src="{{ asset($reward->photo) }}" alt="">
                                            @else
                                            <img class="img-responsive  profile-img" id="wizardPicturePreview" src="" alt="No image">
                                            @endif                                   
                                 ...
                                 <div class="form-group row">
                                    <label class="col-md-3 form-control-label"> Reward Badge <span class="text-danger">*</span> </label>
                                    <div class="col-md-9">                                     
                                        <div class="picture">
                                            @if($reward->badge)
                                            <img  class="img-responsive  profile-img w-100" id="wizardPicturePreview1" src="{{ asset($reward->badge) }}" alt="">
                                            @else
                                            <img class="img-responsive  profile-img w-100" id="wizardPicturePreview1" src="" alt="No image">
                                            @endif                                   
                                            <div class="img-upload-overlay">
                                                <div class="img-upload-overlay-inner">
                                                    <i class="fas fa-camera text-xl"></i>
                                            ...
                                            <input type="file" id="wizard-picture1" class="" name="badge" accept="image/*">
                                        </div>
                                    </div>
                                </div>
