            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-dark table-striped display nowrap" id = "table_one">
                            <thead>
                            <tr>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <table class="table table-dark table-striped display nowrap" id = "table_two">
                            <thead>
                            <tr>
                                <th class = "align-middle pl-2">ID</th>
                                <th class = "align-middle pl-2">Name</th>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-dark table-striped nowrap" id = "table_three">
                            <thead>
                            <tr>
                                <th class = "align-middle pl-2">ID</th>
                                <th class = "align-middle pl-2">Name</th>
