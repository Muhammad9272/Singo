                ...
                @endif
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <form action="{{ route('admin.stores.store') }}" method="POST" class="form-horizontal">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input id="fuga_store_id" type="number" name="fuga_store_id" value="{{ old('fuga_store_id') }}" class="form-control form-control-success">
