                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="">
                                    <table class="table-responsive table table-dark table-hover display nowrap table-striped" id="table_one">
                                        <thead>
                                        <tr>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="">
                                    <table class="table table-hover table-dark table-responsive display nowrap table-striped" id="table_two">
                                        <thead>
                                        <tr>
                                            <th class = "align-middle pl-2">#SL</th>
                                            <th class = "align-middle pl-2">Coupon Code</th>
