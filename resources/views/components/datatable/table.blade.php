        ...
        <tr>
            <td class="align-middle pl-2">
                <img
                    width="50"
                    height="50"
                    src="{{ \Illuminate\Support\Facades\Storage::url('albums/' . $album->id . '/' . $album->cover) }}"
                    alt=""
                >
            </td>
            ...
            @forelse($request as $rq)
                <td class="align-middle pl-2">
                    ...
                    @if ($rq->status == 1 && $rq->isUpdated == 1)
                        <span
                            class="text-success">Updated</span>
                    @endif
            ...
            <td class="align-middle pl-2">
                <div class="btn-group">
                    <a
                        ...
                        class="btn btn-sm btn-link btn-dark">
                        <i class="fas fa-eye"></i>
                        View
                    </a>
                    <a
                        href="{{ route('album.edit', $album->id) }}"
                        class="btn btn-sm btn-link btn-info">
                        <i
                            class="fas fa-edit"></i>
                        Edit
                    </a>
