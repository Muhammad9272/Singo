        ...
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-end"> 
                <div class="picture-container">
                    <h5 class="text-white">Profile Picture</h5>
                    <div class="picture">
                        @if(isset(auth()->user()->profile_picture))
                            <img class="img-responsive img-square profile-img" id="wizardPicturePreview" src="{{ auth()->user()->profile_picture }}" alt="">
                        @else
                    ...
                    <h4 class="text-center mt-4 mb-4" id="">{{ auth()->user()->name }}</h4>

                    <div class="text-center pt-100">
                        <button type="submit" class="singo-btn secondarybgcolor">Update Profile</button>
                    </div>
                </div> 
            </div> 
        </div>
